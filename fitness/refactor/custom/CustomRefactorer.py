...
class CustomRefactorer(Refactorer):
    ...
    def __init__(self, codebase):
        ...
        self.last_refactored_codebase = None
    ...
    def save_to_file(self, info):
        codebase = self.last_refactored_codebase

        filename = 'result/{}_{}.py'.format(info, id(codebase))
    ...
    def apply(self, sequence, *args, **kwargs):
        ...
        for operator_name, target in sequence:
            codebase, success = self.operators[operator_name].apply(
                codebase, target)
        ...
        with open(filename, 'w') as f:
            ...
            self.last_refactored_codebase = codebase

        return filename, success_indices
